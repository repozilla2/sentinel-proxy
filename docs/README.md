...
- **Evidence Packs (examples + format):** `../evidence/packs/README.md`
- **Evidence Pack Example:** `../evidence/packs/EP-20260211-001.json`

## Legacy v0.1 Docs (Prototype Baseline)

- Invariant Contract (v0.1): `01-invariant-contract-v0.1.md`
- Test Matrix (v0.1): `02-test-matrix-v0.1.md`
- Evidence Pack (v0.1): `03-evidence-pack-v0.1.md`
